...
int main(int argc, char const *argv[])
{
    ...
    Arnoldi::allocate_real(N,N,1,1,&A_h);
...
//  init structures
    ...
    int basis=500;
    int iterations=1;
    int flag =  GMRES(handle, N, (user_map_vector) user_Ax_function_1, (Ax_struct_1 *) SC_matmul, x_d, b_d, &tollerance, &basis, iterations, true);
